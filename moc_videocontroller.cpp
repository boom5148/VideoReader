...
**
** Created: Tue Nov 26 20:32:40 2013
...
static const char qt_meta_stringdata_VideoController[] = {
    "VideoController\0"
};
...
const QMetaObjectExtraData VideoController::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VideoController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoController,
      qt_meta_data_VideoController, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VideoController::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoController))
